...
install() {
    bash <(curl -Ls https://raw.githubusercontent.com/muvzpro/xui-amnezia/master/install.sh)
    if [[ $? == 0 ]]; then
        if [[ $# == 0 ]]; then
            start
        else
...
update() {
    ...
    bash <(curl -Ls https://raw.githubusercontent.com/muvzpro/xui-amnezia/master/update.sh)
    if [[ $? == 0 ]]; then
...
update_menu() {
    ...
    curl -fLRo /usr/bin/x-ui https://raw.githubusercontent.com/muvzpro/xui-amnezia/master/x-ui.sh
...
legacy_version() {
    ...
    install_command="bash <(curl -Ls "https://raw.githubusercontent.com/muvzpro/xui-amnezia/v$tag_version/install.sh") v$tag_version"
...
uninstall() {
    ...
    echo -e "${green}bash <(curl -Ls https://raw.githubusercontent.com/muvzpro/xui-amnezia/master/install.sh)${plain}"
    echo ""
...
update_shell() {
    curl -fLRo /usr/bin/x-ui -z /usr/bin/x-ui https://raw.githubusercontent.com/muvzpro/xui-amnezia/master/x-ui.sh
    if [[ $? != 0 ]]; then
        echo ""
