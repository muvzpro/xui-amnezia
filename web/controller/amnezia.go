...
func (a *AmneziaController) getRuntime(c *gin.Context) {
	snapshot, err := a.amneziaService.GetRuntimeSnapshot()
	if err != nil {
		jsonMsg(c, "Failed to load AmneziaWG runtime", err)
		return
	}
